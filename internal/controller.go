...
func (c *Controller) getAuthor(ctx context.Context, authorID int64) (ttlpair, error) {
	...
	// Also capture the pre-refresh snapshot bytes for use below if needed.
	preRefreshBytes, refreshing := c.cache.Get(ctx, refreshAuthorKey(authorID))
